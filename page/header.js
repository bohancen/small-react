...
var Header = function (_Component) {
  ...
  function Header(props) {
    ...
    window.connectHeader = _this.connectHeader.bind(_this);
    window.updataHeader = _this.updataHeader.bind(_this);
    return _this;
  }

  _createClass(Header, [{
    key: 'connectHeader',
    value: function connectHeader(state) {
      this.setState(_extends({}, this.state, state));
    }
  }, {
    key: 'updataHeader',
    value: function updataHeader() {
      var store = localStorage();
      this.setState(_extends({}, this.state, store));
    }
  }, {
    key: 'event',
